...
pth <- "img/yEd_1.png" #system.file("img", "yEd_1.png", package="CellTrails")
...
```{r, eval=TRUE, echo=FALSE}
pth <- "img/yEd_2-3.png" #system.file("img", "yEd_2-3.png", package="CellTrails")
knitr::include_graphics(path=pth)
```
...
```{r, eval=TRUE, echo=FALSE}
pth <- "img/yEd_4.png" #system.file("img", "yEd_4.png", package="CellTrails")
knitr::include_graphics(path=pth)
```
...
```{r, eval=TRUE, echo=FALSE}
pth <- "img/yEd_5-6.png" #system.file("img", "yEd_5-6.png", package="CellTrails")
knitr::include_graphics(path=pth)
```
